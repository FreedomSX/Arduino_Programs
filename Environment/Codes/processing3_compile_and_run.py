...
cmdStr = "D:\\Green_Software\\processing-3.5.4\\processing-java.exe --force --sketch=" + cwd + "\\" + project_name_lst[num_of_project] + " --output=" + cwd + "\\" + project_name_lst[num_of_project] + "\\out --run"
os.system(cmdStr)
...
file_name = "testArduino.ino"

#set the path of the local command
cmd_path = os.getcwd()
# print("cmd_path", cmd_path)
ino_path = os.path.join(cmd_path, file_name)
# # print(ino_path)
...
cmd_str = r"arduino_debug -v --board arduino:avr:uno --pref build.path=" + code_name.split(".")[0].strip() + " --verify \"" + ino_path + "\""
# print(cmd_str)
os.system(cmd_str)
os.system("pause>nul")